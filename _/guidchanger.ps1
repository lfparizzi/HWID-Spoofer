...
echo "`nValor aleatorio a ser definido para "$regValue2": "$newValue2"`n"
...
echo "`n`n"$regValue1" alterado para: "$newValue1
echo $regValue2" alterado para: "$newValue2

Write-Host "`nValores do Registro atualizados com sucesso!`n"
